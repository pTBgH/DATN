  ...
  return (
    <div className="space-y-20">
      ...
      <section className="grid grid-cols-3 gap-6 sm:gap-8">
        <div className="rounded-[16px] bg-white border border-slate-100 shadow-sm p-8 text-center hover:shadow-md transition-shadow duration-300">
          <div className="text-5xl font-serif font-bold text-brand">{jobs.data.length}</div>
          <p className="mt-3 text-xs font-semibold text-slate-500 tracking-wide">CÔ HỘI VIỆC LÀM</p>
        </div>
        <div className="rounded-[16px] bg-white border border-slate-100 shadow-sm p-8 text-center hover:shadow-md transition-shadow duration-300">
          <div className="text-5xl font-serif font-bold text-brand">500+</div>
          <p className="mt-3 text-xs font-semibold text-slate-500 tracking-wide">CÔNG TY HÀNG ĐẦU</p>
        </div>
        <div className="rounded-[16px] bg-white border border-slate-100 shadow-sm p-8 text-center hover:shadow-md transition-shadow duration-300">
          <div className="text-5xl font-serif font-bold text-success">10K+</div>
          <p className="mt-3 text-xs font-semibold text-slate-500 tracking-wide">THÀNH CÔNG</p>
        </div>
      </section>
      ...
      <section>
        <div className="mb-12 flex items-center justify-between gap-6">
          <div>
            <h2 className="text-4xl font-serif font-bold text-slate-900">Việc Làm Nổi Bật</h2>
            <p className="mt-3 text-slate-500 font-light">Những vị trí tuyển dụng hấp dẫn nhất hôm nay</p>
          </div>
          <Link href="/jobs">
        ...
        {jobs.data.length === 0 ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {jobs.data.slice(0, 6).map((j) => (
              ...
              >
                <Card hover className="h-full space-y-5">
