...
| PEP Runtime | Tetragon | `doc/14-tetragon-runtime.md` (thiet ke) | ❌ Du kien — thiet ke TracingPolicy co san |
...
- **Bien (N-S)**: Kong JWT plugin tren tung route
  ...
  - Xem chi tiet: `doc/04-policy-enforcement.md`
...
- **Runtime**: Tetragon (thiet ke, chua deploy)
  ...
  - Xem chi tiet: `doc/14-tetragon-runtime.md`
...
- Xem chi tiet: `doc/03-identity-layer.md`
...
- Xem chi tiet: `doc/05-observability-stack.md`
