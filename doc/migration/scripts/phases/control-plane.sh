#!/usr/bin/env bash
# doc/migration/scripts/phases/control-plane.sh
#
...
#   sudo -E bash doc/migration/scripts/bootstrap.sh --server=01 --phase=control-plane
# Or directly:
#   sudo -E bash doc/migration/scripts/phases/control-plane.sh
