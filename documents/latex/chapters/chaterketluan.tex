...
\begin{itemize}
    ...
    \item Phân tích các rủi ro đặc thù của microservice trên Kubernetes, gồm lưu lượng nội bộ lớn, vòng đời ngắn của thực thể chạy, quản lý bí mật phân tán, rủi ro hạ tầng dùng chung và nguy cơ từ chuỗi cung ứng phần mềm~\parencite{nist800204_microservices,rice2019kubernetes,machine_identity_report}.
...
\begin{itemize}
    \item Triển khai microsegmentation bằng CiliumNetworkPolicy~\parencite{cilium_docs,ebpf_io}: áp dụng chính sách từ chối mặc định cho các không gian tên trọng yếu, sau đó chỉ mở các luồng cần thiết giữa dịch vụ, CSDL, bộ nhớ đệm và thành phần hạ tầng.
    \item Hiện thực hóa quản lý bí mật động bằng HashiCorp Vault~\parencite{vault_docs}: bảy microservices nhận thông tin kết nối CSDL ngắn hạn, được ghi vào bộ nhớ tạm của pod và tự xoay vòng mà không làm gián đoạn ứng dụng~\parencite{nist800207,machine_identity_report}.
