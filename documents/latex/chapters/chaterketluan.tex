...
Sau quá trình nghiên cứu và triển khai thực nghiệm đề tài \textbf{``Nghiên cứu Kiến trúc Zero Trust và Ứng dụng trong Bảo mật Hệ thống Microservices trên Kubernetes''}, đồ án đã hoàn thành các mục tiêu chính: hệ thống hóa cơ sở lý thuyết, đề xuất kiến trúc bảo vệ phù hợp với môi trường Kubernetes và kiểm chứng kiến trúc đó trên hệ thống Job7189.
...
\begin{itemize}
    ...
    \item Đề xuất khung kiến trúc Zero Trust gồm năm thành phần chức năng, ánh xạ từ mô hình tham chiếu của NIST sang các công cụ mã nguồn mở phù hợp với Kubernetes~\parencite{nist800207,kubernetes_docs,cisa_ztmm2023}.
...
Tóm lại, đồ án đã hiện thực hóa được các thành phần cốt lõi của kiến trúc Zero Trust trên một hệ thống vi dịch vụ thực tế: định danh tập trung, phân đoạn mạng vi mô, kiểm soát truy cập theo chính sách, quản lý bí mật động và quan sát tập trung. Kết quả thực nghiệm cho thấy hướng tiếp cận này khả thi trong môi trường phòng thí nghiệm, đồng thời tạo nền tảng để tiếp tục hoàn thiện cơ chế phản hồi tự động, đánh giá rủi ro liên tục và vận hành ở mức cưỡng chế cao hơn.
