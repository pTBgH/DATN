  ...
  return (
    <div className="space-y-10">
      <section className="rounded-xl bg-gradient-to-r from-brand to-brand-dark p-10 text-white shadow">
        <h1 className="text-3xl font-bold">Job7189 — Zero-trust hiring</h1>
        <p className="mt-2 max-w-2xl text-brand-100">
          Frontend Next.js + TypeScript, deploy trên Cloudflare Pages, kết nối tới
          7 microservice Laravel qua Kong gateway và xác thực bằng Keycloak realm{" "}
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {jobs.data.slice(0, 6).map((j) => (
            <Link
              ...
              className="rounded-lg border bg-white p-4 hover:border-brand"
            >
