...
| PR #8 | 2.3.2 Zero Trust DAAS + microperimeter | PIP 4 — DAAS classification van ban hoa (`knowledge-base/18-daas-classification.md`); CNP per-namespace dat trong `infras/k8s-yaml/cilium-policies/namespaces/`; audit findings F-1/F-2/F-4 fixed (`knowledge-base/22-audit-findings-remediation.md`) |
...
- Architecture: `knowledge-base/02-architecture-layers.md`
- Identity: `knowledge-base/03-identity-layer.md`
- Observability: `knowledge-base/05-observability-stack.md`
