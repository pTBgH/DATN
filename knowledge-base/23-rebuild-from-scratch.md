...
> `knowledge-base/migration/README.md` cho VM-mode trường hợp.
...
làm. Xem `knowledge-base/31-falco-deprecated.md` + `knowledge-base/incident-falco-tetragon-ram-overcommit.md`
