...
runtime use-cases. Xem `knowledge-base/31-falco-deprecated.md` +
`knowledge-base/incident-falco-tetragon-ram-overcommit.md`.
...
#     knowledge-base/migration/scripts/99-rollback.sh / decommission-srv04.sh)
