...
**Closes:** knowledge-base/34-microseg-phase2c-plan.md §7 "Open items — long Hubble watch".
...
folder and reference the run timestamp in `knowledge-base/34-microseg-phase2c-plan.md`
§7 Open items.
