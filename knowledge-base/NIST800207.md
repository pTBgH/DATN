...
http://www.acqnotes.com/Attachments/DoD%20GIG%20Architectural%
...
[IBNVN] Cohen R, Barabash K, Rochwerger B, Schour L, Crisan D, Birke R,
...
2020. https://doi.org/10.6028/NIST.SP.800-63-3
...
updates as of March 2, 2020. https://doi.org/10.6028/NIST.SP.800-63A
[SP800-160v1] Ross R, McEvilley M, Oren JC (2016) Systems Security Engineering:
...
[SP800-160v2] Ross R, Pillitteri V, Graubart R, Bodeau D, McQuaid R (2019)
...
| This publication is available free of charge from: https://doi.org/10.6028/NIST.SP.800-207  | G2B   | Government to Business (private industry)       |     |     |
...
| ---------- | ----------------------- | --- | ----------------- | --- |
|            | •                       |     | •                 |     |
| Immediate  | How should procurement  |     | Lack of a common  |     |
deployment  requirements be written?  framework and vocabulary
for ZTA
•
How does a ZTA plan work with
|     | TIC, FISMA, and other  |     | •  Perception that ZTA   |     |
| --- | ---------------------- | --- | ------------------------ | --- |
|     | requirements?          |     | conflicts with existing  |     |
policy
...
|     | •   |     | •   |     |
| --- | --- | --- | --- | --- |
Areas needing  How will threats evolve in the face of  What a successful
| more research  | ZTA?  |     | compromise looks like in  |     |
| -------------- | ----- | --- | ------------------------- | --- |
an enterprise with a ZTA
•
How will business processes change
|     | in the face of ZTA?  |     | •  Documented end user  |     |
| --- | -------------------- | --- | ----------------------- | --- |
