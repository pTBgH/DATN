...
> repo này từ PR-D cleanup parallel. Tetragon (xem `knowledge-base/14-tetragon-runtime.md`)
> phủ toàn bộ runtime detection use-cases mà Falco từng làm trên cụm 1-node lab.
>
> **Lý do gỡ:** xem `knowledge-base/incident-falco-tetragon-ram-overcommit.md`. Tóm tắt:
