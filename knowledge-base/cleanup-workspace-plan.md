...
| **PR-D** | `pr-d-verify-warnings-falco` | `09-verify-zta.sh` 10 WARN fixes + xóa Falco hoàn toàn (`scripts/zta-deploy-falco.sh`, `infras/k8s-yaml/falco/`, `knowledge-base/31` mark deprecated) |
...
- `mdfile/` toàn bộ (43 file) **trừ** `mdfile/important/` 3 file → MOVE → `knowledge-base/architecture/`

**Move into `knowledge-base/archive/`:**
- `app-behavior-analysis.md` → `knowledge-base/archive/`
- `dynamic-secret-test.md` → `knowledge-base/archive/`
- `mitigation-strategies.md` → `knowledge-base/archive/`
- `require.md` → `knowledge-base/archive/01-original-requirements.md`
- `sequence-diagram.md` → `knowledge-base/archive/`
- `startup_flow_analysis.md` → `knowledge-base/archive/`
- `vault-agent-startup-race-condition.md` → `knowledge-base/archive/`
- `vault-agent-verification.md` → `knowledge-base/archive/`
- `API-AUTHENTICATION-GUIDE.md` → `knowledge-base/api-authentication-guide.md` (active KB)

**Move into `knowledge-base/architecture/`:**
...
(link `knowledge-base/README.md`, `scripts/zta-rebuild.sh`, pre-flight checklist).
...
- `deploy-all.sh` (1 ref trong knowledge-base/23 — sửa knowledge-base/23)
...
- `knowledge-base/00-project-overview.md`, `knowledge-base/19-label-schema.md`, `knowledge-base/23-rebuild-from-scratch.md` — note "frontend dev độc lập trong `frontend/` (không build trong pipeline ZTA)".
...
- `knowledge-base/31-falco-runtime-detection.md` — thêm header "DEPRECATED — replaced by Tetragon (`knowledge-base/14-tetragon-runtime.md`). Kept for thesis history."
- `knowledge-base/incident-falco-tetragon-ram-overcommit.md` — note xác định Falco đã bỏ
- `knowledge-base/32-deploy-script-troubleshooting.md` — gỡ Falco out of troubleshooting matrix
