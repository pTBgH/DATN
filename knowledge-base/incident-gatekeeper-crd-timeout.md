...
- `knowledge-base/incident-falco-tetragon-ram-overcommit.md` — earlier root cause of host
  overcommit that led to this secondary failure.
- `knowledge-base/incident-gatekeeper-probe-webhook-stuck.md` — follow-up failure
