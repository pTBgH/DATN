...
> hoặc chạy `bash knowledge-base/migration/scripts/onboard-srv05.sh` (host-prep.sh
...
# auth bằng pre-shared key (xem knowledge-base/migration/04-network-tailscale-cilium.md §3)
sudo tailscale up \
