...
nano knowledge-base/migration/scripts/config.env
```
...
```bash
# Trên srv01:
sudo HOSTNAME_OVERRIDE=7189srv01 -E bash knowledge-base/migration/scripts/01-host-prep.sh

# Trên srv02:
sudo HOSTNAME_OVERRIDE=7189srv02 -E bash knowledge-base/migration/scripts/01-host-prep.sh
