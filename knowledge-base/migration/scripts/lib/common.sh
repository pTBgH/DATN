#!/usr/bin/env bash
# knowledge-base/migration/scripts/lib/common.sh
#
...
# ===== Config loader =====
load_config() {
  # Loads knowledge-base/migration/scripts/config.env if present.
  ...
  export TAILNET_DOMAIN CP_HOSTNAME WORKER_HOSTNAMES DATA_NODE \
         KUBE_VERSION KUBE_MINOR CILIUM_VERSION \
         CRICTL_VERSION CNI_PLUGINS_VERSION KUBE_RELEASE_TEMPLATE_VERSION \
         POD_CIDR SVC_CIDR \
