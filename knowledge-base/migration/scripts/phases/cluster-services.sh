#!/usr/bin/env bash
# knowledge-base/migration/scripts/phases/cluster-services.sh
#
...
#   sudo -E bash knowledge-base/migration/scripts/bootstrap.sh --server=01 --phase=cluster-services
# Or directly:
#   bash knowledge-base/migration/scripts/phases/cluster-services.sh
