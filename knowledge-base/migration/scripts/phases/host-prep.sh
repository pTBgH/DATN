#!/usr/bin/env bash
# knowledge-base/migration/scripts/phases/host-prep.sh
#
...
#
# Usage:
#   sudo -E bash knowledge-base/migration/scripts/01-host-prep.sh
#   # or with explicit hostname:
#   sudo HOSTNAME_OVERRIDE=7189srv02 -E bash knowledge-base/migration/scripts/phases/host-prep.sh
#   # dry-run:
#   sudo ZTA_DRY_RUN=1 -E bash knowledge-base/migration/scripts/phases/host-prep.sh
#
