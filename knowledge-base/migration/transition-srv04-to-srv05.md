...
`knowledge-base/migration/incident-srv04-tailscale-derp-2026-05-13.md`.

This document is a runbook. Scripts referenced live under
`knowledge-base/migration/scripts/`. Nothing in the existing migration pipeline
...
```bash
cd ~/projects/DATN/knowledge-base/migration/scripts
# If you haven't yet:
...
```bash
cd ~/projects/DATN
sudo -E bash knowledge-base/migration/scripts/decommission-srv04.sh --yes
```
...
```bash
$EDITOR knowledge-base/migration/scripts/config.env
# WORKER_HOSTNAMES="7189srv02 7189srv03 7189srv05"  # remove srv04
# DATA_NODE="7189srv05"

$EDITOR knowledge-base/migration/PROGRESS.md
# Add a "Recent events" entry noting the swap. Bump cluster facts table.

git add knowledge-base/migration/scripts/config.env knowledge-base/migration/PROGRESS.md
...
data tier) per `knowledge-base/migration/PROGRESS.md`:
