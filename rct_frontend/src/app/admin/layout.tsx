    ...
    <div className="grid gap-6 lg:grid-cols-[200px_1fr]">
      <aside className="rounded-lg border bg-white p-3 text-sm">
        ...
        <nav className="mt-1 flex flex-col gap-0.5">
          <SideLink href="/admin">Tổng quan</SideLink>
          <SideLink href="/admin/jobs">Duyệt tin tuyển dụng</SideLink>
          <SideLink href="/admin/sectors">Ngành nghề</SideLink>
          <SideLink href="/admin/users">Người dùng</SideLink>
          <SideLink href="/admin/companies">Công ty</SideLink>
        </nav>
      </aside>
