...
export default function HomePage() {
  return (
    <div className="space-y-12">
      {/* Hero Section */}
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-indigo-600 to-slate-700 px-6 py-16 sm:px-12 sm:py-24 text-white shadow-xl">
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/recruiter">
              <Button variant="primary" size="lg" className="bg-white text-purple-600 hover:bg-purple-50">
        ...
        <div className="absolute -bottom-20 -left-20 h-40 w-40 rounded-full bg-purple-400/10 blur-3xl"></div>
      </section>
      ...
      <section className="rounded-2xl bg-slate-900 px-6 py-12 sm:px-12 sm:py-16 text-center text-white">
        ...
        <p className="mt-2 text-slate-300">Tối ưu hóa quy trình tuyển dụng và tìm được ứng viên tuyệt vời.</p>
    ...
    <Link href={href}>
      <Card hover>
        <div className="space-y-4">
          <div className={`inline-flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br ${color} text-2xl`}>
            {icon}
          </div>
          <div>
          ...
          <ul className="space-y-2">
            {features.map((feature, i) => (
              <li key={i} className="flex items-center gap-2 text-sm text-slate-700">
                <span className="text-cyan-600">✓</span> {feature}
              </li>
            ))}
          </ul>
          <div className="pt-2">
