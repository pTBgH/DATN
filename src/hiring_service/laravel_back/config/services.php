...
return [
    ...
    */
    ...
    'keycloak' => [
        ...
        'clients' => [
            'recruiter' => env('KEYCLOAK_RECRUITER_CLIENT_ID', 'recruiter-app-dev'),
            'candidate' => env('KEYCLOAK_CANDIDATE_CLIENT_ID', 'candidate-app-dev'),
        ],
    ],
    ...
    'microservices' => [
        ...
        'workspace' => env('WORKSPACE_SERVICE_URL', 'http://workspace-service'),
        'job'       => env('JOB_SERVICE_URL', 'http://job-service'),
        'candidate' => env('CANDIDATE_SERVICE_URL', 'http://candidate-service'),
    ],
